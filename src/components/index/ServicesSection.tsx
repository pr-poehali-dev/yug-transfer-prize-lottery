...
const CLIENT_STORES = [
  {
    name: "Google Play",
    icon: "Play",
    href: "https://play.google.com/store/apps/details?id=com.grigor.ygclient",
  ...
  },
  {
    name: "App Store",
    icon: "Apple",
    href: "https://apps.apple.com/app/id6474932294",
  ...
  },
  {
    name: "RuStore",
    icon: "Store",
    href: "https://www.rustore.ru/catalog/app/com.grigor.ygclient",
