    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="mt-6 card-glow rounded-2xl p-6">
        ...
        <div className="space-y-3">
          {[
            { q: "Как заказать трансфер?", a: "Напишите нам в Telegram или позвоните — оформим поездку за пару минут." },
            { q: "Куда возите?", a: "Аэропорт, межгород, по Краснодарскому краю и Крыму. Любые направления." },
            { q: "Как стать водителем?", a: "Подключите подписку через бота @zacazubot и получайте заказы." },
          ].map((faq, i) => (
