        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-white/40 text-xs">Telegram @ug_transfer_pro + WordPress · Осталось: {unusedCount} из {posts.length}</p>
            </div>
          </div>
      ...
      <div className="rounded-2xl border border-white/8 p-6" style={{ background: "rgba(255,255,255,0.02)" }}>
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-white/40 text-xs">Ежедневная отправка в Telegram + WordPress в 09:00 МСК</p>
          </div>
        </div>
        ...
        <div className="space-y-3 text-sm">
          ...
          <div className="rounded-xl bg-amber-500/10 border border-amber-500/20 px-4 py-3 text-xs text-amber-200 flex items-start gap-2 mt-2">
            ...
            <span>Каждый день в 09:00 МСК очередной пост из списка выше автоматически уйдёт в Telegram и на WordPress. Когда все посты закончатся — цикл начнётся сначала.</span>
          </div>
        </div>
      </div>
    </div>
