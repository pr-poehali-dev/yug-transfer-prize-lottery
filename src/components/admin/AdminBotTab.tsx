        ...
        {showAdd && (
          <div className="mb-6 p-5 rounded-xl border border-purple-500/20 bg-purple-500/5 space-y-4">
            ...
            <div>
              ...
              <input value={form.photo_url} onChange={e => setForm(f => ({ ...f, photo_url: e.target.value }))} placeholder="https://..." className="w-full px-3 py-2 rounded-lg bg-white/5 border border-white/10 text-white text-sm outline-none focus:border-purple-500/40" />
            </div>
            <div>
            ...
            {form.photo_url && (
              <img src={form.photo_url} alt="preview" className="w-32 h-32 object-cover rounded-xl border border-white/10" />
            )}
            <div className="flex gap-2">
