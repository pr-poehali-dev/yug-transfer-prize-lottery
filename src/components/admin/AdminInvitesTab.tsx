  ...
  return (
    <div className="space-y-4">
      <div className="glass rounded-2xl p-5 border border-white/5">
        ...
        <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-3 text-xs text-amber-200/90 mb-4">
          <div className="flex gap-2">
            ...
            <div className="space-y-1">
              ...
              <ul className="list-disc pl-4 space-y-0.5 opacity-90">
                ...
                <li>Используется тот же user-аккаунт, что и для сторис — при бане сломаются и сторис</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="rounded-xl border border-white/10 p-3">
            <div className="text-[10px] uppercase text-muted-foreground tracking-wider">Кандидатов в БД</div>
            <div className="text-2xl font-bold mt-1">—</div>
          </div>
          <div className="rounded-xl border border-white/10 p-3">
            <div className="text-[10px] uppercase text-muted-foreground tracking-wider">Добавлено всего</div>
            <div className="text-2xl font-bold mt-1 text-green-400">—</div>
          </div>
          <div className="rounded-xl border border-white/10 p-3">
            <div className="text-[10px] uppercase text-muted-foreground tracking-wider">Сегодня</div>
            <div className="text-2xl font-bold mt-1 text-purple-400">0/{dailyLimit}</div>
          </div>
        </div>
      </div>
      ...
      <div className="glass rounded-2xl p-5 border border-white/5">
        ...
        <div className="flex items-end gap-3">
          <div className="flex-1">
            <label className="text-xs text-muted-foreground mb-1 block">Лимит добавлений в день</label>
            <input
              type="number"
              min={1}
              max={30}
      ...
      <div className="glass rounded-2xl p-5 border border-white/5">
        ...
        <div className="mt-3 text-xs text-muted-foreground text-center">
          Бэкенд ещё не подключён — кнопки активируем на следующем шаге
        </div>
      </div>

      <div className="glass rounded-2xl p-5 border border-white/5">
        <h3 className="text-sm font-semibold mb-3">История попыток</h3>
        <div className="text-xs text-muted-foreground text-center py-6">
          Здесь появится список: кого добавили, кто отказал, кому ушла ссылка
        </div>
      </div>
    </div>
  );
