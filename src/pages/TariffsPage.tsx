  ...
  return (
    <PageShell title="Тарифы" icon="Wallet">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-2.5">
        ...
        <Link to="/" className="flex flex-col items-center justify-center gap-1.5 bg-amber-500 hover:bg-amber-400 text-black font-bold rounded-xl p-4 transition-colors">
          <Icon name="Plus" size={22} />
          <span className="text-sm text-center">Заказать трансфер</span>
        </Link>
      </div>
    </PageShell>
  );
