...
export default function RoutesPage() {
  useSEO({
    title: "Направления трансфера: Краснодар, Сочи, Анапа, Геленджик, Крым — цены и время в пути",
    description:
      "Трансфер по Краснодарскому краю, к морю и в Крым через Крымский мост: Краснодар — Сочи, Анапа, Геленджик, Новороссийск, Симферополь, Ялта. Трансфер в аэропорт, междугородние поездки и доставка. Время в пути и цены от перевозчика, заказ онлайн.",
  });
