...
const DriverDemo = () => {
  return (
    <div className="h-screen overflow-hidden bg-zinc-950 text-white flex flex-col">
      <header className="px-6 pt-4 flex-shrink-0">
        <div className="max-w-[1600px] mx-auto bg-zinc-900/90 backdrop-blur border border-zinc-800 rounded-full px-6 py-3 flex items-center justify-between">
      ...
      <main className="flex-1 min-h-0 px-6 py-4">
        <div className="max-w-[1600px] mx-auto h-full grid lg:grid-cols-[460px_1fr] gap-5">
          <aside className="bg-zinc-900/95 backdrop-blur border border-zinc-800 rounded-3xl p-5 shadow-2xl overflow-y-auto">
            <div className="mb-4">
          ...
          <section className="relative rounded-3xl overflow-hidden border border-zinc-800 bg-zinc-900">
            <iframe
            ...
            <div className="absolute bottom-4 right-4 bg-zinc-900/95 backdrop-blur border border-zinc-800 rounded-2xl p-4 max-w-[290px]">
            ...
            <div className="absolute bottom-4 left-4 right-[310px] hidden xl:grid grid-cols-4 gap-2">
              {[
                ...
                <div
                  key={f.title}
                  className="bg-zinc-900/90 backdrop-blur border border-zinc-800 rounded-xl px-3 py-2 flex gap-2 items-center"
                >
