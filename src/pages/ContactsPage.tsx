...
export default function ContactsPage() {
  useSEO({
    ...
    description:
      "Свяжитесь с нами для заказа трансфера: телефон, почта, Telegram и MAX. Работаем круглосуточно без выходных по Краснодарскому краю. Поможем подобрать машину и рассчитать цену.",
  });
