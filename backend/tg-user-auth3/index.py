"""Telethon-логин ТРЕТЬЕГО user-аккаунта (специально для парсера групп)."""
import os
import json
import hashlib
import asyncio
...
SESSION_TABLE = 'tg_user_session3'
...
def handler(event: dict, context) -> dict:
    """Логин третьего user-аккаунта Telegram (для парсера групп)."""
