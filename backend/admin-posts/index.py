...
ALL_CHATS = ['main', 'vip', 'horse', 'chat4', 'chat5', 'chat6', 'chat7', 'chat8', 'chat9', 'chat10', 'chat11']
...
def handler(event: dict, context) -> dict:
    ...
    channel_chat10 = os.environ.get('POSTS_CHAT_10_ID', '') or '-1002132967829'
    channel_chat11 = os.environ.get('POSTS_CHAT_11_ID', '') or '@pravila_grypu'
    ...
    if method == 'POST' and action == 'send_missing':
        ...
        channels = {'main': channel_main, 'vip': channel_vip, 'horse': channel_horse,
                    ...
                    'chat7': channel_chat7, 'chat8': channel_chat8, 'chat9': channel_chat9, 'chat10': channel_chat10, 'chat11': channel_chat11}
    ...
    if method == 'POST' and action == 'publish':
        ...
        post = row_to_post(row)
        channels = {'main': channel_main, 'vip': channel_vip, 'horse': channel_horse, 'chat4': channel_chat4, 'chat5': channel_chat5, 'chat6': channel_chat6, 'chat7': channel_chat7, 'chat8': channel_chat8, 'chat9': channel_chat9, 'chat10': channel_chat10, 'chat11': channel_chat11}
    ...
    if method == 'PUT':
        ...
        if already_live and bot_token and status != 'expired':
            channels = {'main': channel_main, 'vip': channel_vip, 'horse': channel_horse,
                        ...
                        'chat10': channel_chat10, 'chat11': channel_chat11}
