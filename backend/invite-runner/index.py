...
SINGLE_RUN_MAX = 20              # макс инвайтов за один запуск с ОДНОГО аккаунта (укладывается в таймаут 30с)
TIME_BUDGET_SEC = 25            # жёсткий лимит времени на пачку, чтобы не словить таймаут функции (30с)
